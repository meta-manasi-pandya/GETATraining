...
public class ProductFacade {
	...
	private InMemoryProductDao inMemoryProductDao =(InMemoryProductDao) ProductFactory.getInstance(DatabaseEnum.IN_MEMORY);
	...
	/**
	 * this method returns the list of products came from in-memory storage
