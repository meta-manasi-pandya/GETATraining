...
public class Workflow {
	...
	private List<Event> listOfEvents = new ArrayList<Event>();					//list of event type objects
	private List<Transition> listOfTransition = new ArrayList<Transition>();	//list of transition type objects
	private LinkedList<State> listOfStates = new LinkedList<State>();			//linked list of state objects
