...
public class TemperatureConverterServiceLocator extends org.apache.axis.client.Service implements com.metacube.temperature.TemperatureConverterService {
    ...
    private java.lang.String TemperatureConverter_address = "http://localhost:8080/TemperatureServer/services/TemperatureConverter";
    ...
    public com.metacube.temperature.TemperatureConverter getTemperatureConverter() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.temperature.TemperatureConverter getTemperatureConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.temperature.TemperatureConverterSoapBindingStub _stub = new com.metacube.temperature.TemperatureConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.temperature.TemperatureConverter.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.temperature.TemperatureConverterSoapBindingStub _stub = new com.metacube.temperature.TemperatureConverterSoapBindingStub(new java.net.URL(TemperatureConverter_address), this);
                _stub.setPortName(getTemperatureConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://temperature.metacube.com", "TemperatureConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://temperature.metacube.com", "TemperatureConverter"));
        }
